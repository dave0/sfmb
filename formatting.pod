...
text/plain is rendered as-is, as plain text.  text/html may contain
HTML.  text/x-markdown is formatted in the simple markup language
...
=head1 Inline options

=head2 <read more>

Inserting a <read more> tag inside the body of your post will let vimblog
